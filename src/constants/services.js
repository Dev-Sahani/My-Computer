...
const services = [
    {
        ...
        icon: <GiAutoRepair className="w-6 h-6 sm:w-8 sm:h-8 md:w-10 md:h-10 lg:w-12 lg:h-12 -translate-y-[2px]" />
    },
    {
        ...
        icon: <PiSecurityCameraFill className="w-6 h-6 sm:w-8 sm:h-8 md:w-10 md:h-10 lg:w-12 lg:h-12 -translate-y-[2px]" />
    },
    {
        ...
        icon: <Percent className="w-6 h-6 sm:w-8 sm:h-8 md:w-10 md:h-10 lg:w-12 lg:h-12 -translate-y-[2px]" />
    },
    {
        ...
        icon: <PiFingerprintLight className="w-6 h-6 sm:w-8 sm:h-8 md:w-10 md:h-10 lg:w-12 lg:h-12 -translate-y-[2px]" />
    },
    {
        ...
        icon: <MdOutlineSecurity className="w-6 h-6 sm:w-8 sm:h-8 md:w-10 md:h-10 lg:w-12 lg:h-12 -translate-y-[2px]" />
    },
    {
        ...
        icon: <RiCustomerService2Fill className="w-6 h-6 sm:w-8 sm:h-8 md:w-10 md:h-10 lg:w-12 lg:h-12 -translate-y-[2px]" />
    }
];
